...
public final class ResourceIds {
    ...
    public static class Font {
        ...
        public static final TextColor RANK_ADMIN_COLOR = TextColor.fromHexString("#e773ad");
        public static final String RANK_MOD = "\uE301";
        public static final TextColor RANK_MOD_COLOR = TextColor.fromHexString("#946ded");
        public static final String RANK_DEV = "\uE302";
        public static final TextColor RANK_DEV_COLOR = TextColor.fromHexString("#ffcf38");
        public static final String RANK_STAFF = "\uE303";
        public static final TextColor RANK_STAFF_COLOR = TextColor.fromHexString("#48b6e6");
    ...
    public static class Model {
        ...
        /* (Noah) Map Icons */
        public static final int NOAH_MAP_NOAHCOMPANY = 2500;
        public static final int NOAH_MAP_PYTHON = 2501;
        public static final int NOAH_MAP_RIMA = 2502;
        public static final int NOAH_MAP_SAINTBELT = 2503;
    }
}
